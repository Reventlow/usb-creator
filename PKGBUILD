...
source=('usb-creator' 'README.md' 'LICENSE' 'docs/usb-creator.1'
        'docs/tldr/usb-creator.md')
sha256sums=('SKIP' 'SKIP' 'SKIP' 'SKIP' 'SKIP')

package() {
    install -Dm755 usb-creator "$pkgdir/usr/bin/usb-creator"
    install -Dm644 README.md "$pkgdir/usr/share/doc/$pkgname/README.md"
    install -Dm644 usb-creator.1 "$pkgdir/usr/share/man/man1/usb-creator.1"
    install -Dm644 usb-creator.md "$pkgdir/usr/share/doc/$pkgname/tldr.md"
